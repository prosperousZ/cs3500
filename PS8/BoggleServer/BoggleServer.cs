					...
					lock (clients)
					{
						if (clients.Count == 1)
						{
							if (specificDice.Equals(""))
								currentGames.Add(new game(this,tempPlayer, clients.Dequeue(), timePerRound));
							else
							{
								currentGames.Add(new game(this,tempPlayer, clients.Dequeue(), timePerRound, specificDice));
							}
						}
						else
